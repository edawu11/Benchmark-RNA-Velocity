...
| **Data 5** | Pancreas batch | GEO: [GSE132188](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE132188) |
| **Data 6** | HSPCs batch | GEO: [GSE209878](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE209878), [GSE284047](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE284047) |
| **Data 7** | scRNA-seq brain | GEO: [GSE162170](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE162170) |
| **Data 8** | snRNA-seq brain | [Download Link](https://cell2fate.cog.sanger.ac.uk/browser.html) |
| **Data 9** | scEU-seq organoid | `dynamo.sample_data.scEU_seq_organoid()` |
| **Data 10** | scNT-seq cortical neuron | `dynamo.scNT_seq_neuron_splicing()`<br>`dynamo.scNT_seq_neuron_labeling()` |
| **Data 11** | FUCCI U2OS | [Figshare Download](https://figshare.com/articles/dataset/FUCCI_U2OS_cells/22773761?file=40461716) |
| **Data 12** | Lineage-tracing LUAD | ENA: [PRJNA803321](https://www.ebi.ac.uk/ena/browser/view/PRJNA803321); [Zenodo Download](https://zenodo.org/records/5847462) |
| **Data 13** | Murine embryonic | GEO: [GSE142425](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE142425) |
| **Data 14** | Primary visual cortex | GEO: [GSE190940](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE190940) |
| **Data 15** | Reprogramming (Morris) | `cellrank.datasets.reprogramming_morris()` |
| **Data 16** | Reprogramming (Schiebinger) | GEO: [GSE122662](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE122662) |
| **Data 17** | PBMC68k | `scvelo.datasets.pbmc68k()` |
| **Data 18** | PBMC194 | [10x Genomics Dataset](https://www.10xgenomics.com/datasets/pbm-cs-from-a-healthy-donor-whole-transcriptome-analysis-3-1-standard-4-0-0) |
...
For evaluation and visualization, we developed the Python package [VeloEV](https://github.com/edawu11/VeloEV). Please refer to the [documentation](https://veloev.readthedocs.io/en/latest/) for detailed tutorials.
